...
const sortInputArray = (event) => {
  ...
  const sortedValues = inputValues.sort((a, b) => {
    return a - b;
  }); //update this function call depending on which kind of sort you want to use, e.g. = selectionSort(inputValues);
...
/* This time, you'll be implementing a selection sort. Selection sort works by finding the smallest value in the array, then swapping it with the first value in the array. Then, it finds the next smallest value in the array, and swaps it with the second value in the array. It continues iterating through the array until it is completely sorted. */
