...
const story = [
	...
	{
		sceneID: "A122",
		sceneText: "You tilt your head and give the guard a look that can only be described as <em>royally confused.</em> \"Is there a...'No Paperwork' option for, you know, someone embarking on a <em>quest of epic proportions?\"</em> you ask, your voice dripping with the kind of gravitas reserved for ancient heroes.<bnr><br>The guard blinks, then scratches his chin thoughtfully. \"Well, technically, you could forgo the forms,\" he begins, \"but then you’d be on what we call 'heroic probation.' No kingdom benefits, no free armor repairs, and&#8212\" he leans in closer, dropping his voice to a conspiratorial whisper, \"&#8212you can't use the royal throne room for battle strategy meetings.\"",
